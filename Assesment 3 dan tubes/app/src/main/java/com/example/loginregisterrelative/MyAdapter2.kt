...
class MyAdapter2(private val context : Activity, private val arrayList: ArrayList<User> ) : ArrayAdapter<User>(context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val lastMsgtime : TextView = view.findViewById(R.id.waktu)
